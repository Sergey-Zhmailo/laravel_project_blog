...
<div class="col-lg-4 col-md-6 col p-2">
    <div class="card post-item">
        ...
        <a href="{{ route('categories.show', $post->post_category->slug) }}"><span class="badge bg-white text-black category-badge">{{
        ...
        <div class="tags-wrapper">
            @if($post->post_tags())
                @foreach($post->post_tags as $tag)
                    <a href="{{ route('tags.show', $tag->slug) }}"><span class="badge bg-white
                    text-black">{{
        ...
        <a href="{{ route('posts.show', $post->slug) }}"><img src="{{ $post->image }}" class="card-img-top" alt="{{
        $post->title }}"></a>
        <div class="card-body">

                        ...
                        <div class="card-body">
                            <form action="{{ route('profile_process') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="input-group has-validation mb-3">
                                            <span class="input-group-text" id="avatar-image-disabled-label">Avatar image</span>
                                            <input type="text"
                                        ...
                                        <div class="input-group has-validation mb-3">
                                            <input class="form-control" type="file" id="avatar-image" name="avatar-image">
                                            @error('avatar-image')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="avatar-wrapper p-4">
                                            @if(auth('web')->user()->image)
                                                <img src="{{ storage_path('app/') . auth('web')->user()->image }}"
